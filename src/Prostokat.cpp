...
bool Prostokat::CzyProstokat() {
  ...
  std::cout << "\tDlugosc pierwszego boku: " << std::fixed
            << std::setprecision(10) << bok1 << std::endl;
  std::cout << "\tDlugosc drugiego boku:   " << std::fixed
            << std::setprecision(10) << bok3 << std::endl
            << std::endl;
  ...
  std::cout << "\tDlugosc pierwszego boku: " << std::fixed
            << std::setprecision(10) << bok2 << std::endl;
  std::cout << "\tDlugosc drugiego boku:   " << std::fixed
            << std::setprecision(10) << bok4 << std::endl
            << std::endl;

  return true;
}

Prostokat::~Prostokat() { system("rm temp.dat"); }
